...
- после запуска (github Pages) в "Загрузить пример RDF данных" выбрать например, Turtle и нажать кнопку "Визуализировать". Будет построен граф:   
![ris](https://habrastorage.org/r/w1560/getpro/habr/upload_files/eb0/e3d/260/eb0e3d260c9cb0cf3c1014317fb1aad1.png)

Управлять видимостью элементов графа можно через фильтры ("Фильтры типов:"), в данном варианте только через типы предикатов, но можно дополнить и фильтрацию через типы \ классы объектов-сущностей (субъектов).
